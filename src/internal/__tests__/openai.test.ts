...
describe("OpenAI Client", () => {
    ...
    it("should successfully call OpenAI Prompt Caching API and marshal response", async () => {
        ...
        const result: OpenAIResponse<TestScoreResponse> = await callOpenAI("pmpt_692222fca0d4819789bdeb9c96525da6082582f7a47f178f", "2", "This is a test of my TTS filter beep boop", "gpt-4o");
    ...
    it("should handle multi-turn conversation with separate prompts", async () => {
        ...
        const result: OpenAIResponse<TestScoreResponse> = await callOpenAI("pmpt_692222fca0d4819789bdeb9c96525da6082582f7a47f178f", "2", "My sprinkler goes tss tsss ttsss tstst tssst pssst prrffffffft", "gpt-4o");
    ...
    it("should handle API key not configured", async () => {
        ...
        const result: OpenAIResponse<TestScoreResponse> = await callOpenAIFresh("pmpt_test", "1", "test", "gpt-4o");
    ...
    it("should handle JSON parsing error and report it", async () => {
        ...
        const result: OpenAIResponse<TestScoreResponse> = await callOpenAI("pmpt_test", "1", "test", "gpt-4o");
    ...
    it("should handle OpenAI API error responses", async () => {
        mockedOpenAI.prototype.responses = {
            create: jest.fn().mockRejectedValue(new Error("401 Incorrect API key provided: test-api-key"))
        } as any;
    ...
    it("should handle network timeout", async () => {
        mockedOpenAI.prototype.responses = {
            create: jest.fn().mockRejectedValue(new Error("Request timed out after 10000ms"))
        } as any;
...
describe("OpenAI Moderation", () => {
    ...
    it("should handle moderation API error responses", async () => {
        mockedOpenAI.prototype.moderations = {
            create: jest.fn().mockRejectedValue(new Error("429 Rate limit exceeded"))
        } as any;
